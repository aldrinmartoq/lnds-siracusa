...
# Si tabulamos hasta n=2 no hay necesidad de programar casos raros.
# 1: 4,2,1.           => 3
# 2: 1.               => 1
# 3: 10,5,16,8,4,2,1  => 7
# 4: 2,1.             => 2
...
def s(i)
  ...
  # 10.000.000 es aprox 200MiB en mi tarro
  $c[i] = b if i < 10_000_000
...
#       puts imprime y hay que sumar 1 porque los índices parten de 0
